        ...
        for (const plane of data) {
            for (const panel of plane.panels) {
                ...
                await Promise.all(panel.subPanels.map(async subPanel => {
                    ...
                    subPanel.panelSize = result[subPanel.definitions].panelSize;
                    subPanel.backgroundImage = result[subPanel.definitions].backgroundImage;
                    subPanel.definitions = result[subPanel.definitions].panelControlDefinitions;
